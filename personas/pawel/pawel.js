...
addStyles(
  "html { filter: invert(1) hue-rotate(180deg) sepia(1) !important; } img, video, iframe, .wds-img-element.wds-img-animation-0::before { filter: invert(1) hue-rotate(180deg) !important; }",
);
...
function beep(start, duration, frequency, volume, type, callback) {
  ...
  oscillator.stop(
    audioCtx.currentTime + (start || 0) / 1000 + (duration || 500) / 1000,
  );
}
